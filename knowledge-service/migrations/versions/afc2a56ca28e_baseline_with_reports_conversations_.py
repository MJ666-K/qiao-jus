"""baseline with reports conversations messages

Revision ID: afc2a56ca28e
Revises: 
Create Date: 2026-06-22 23:35:56.081932
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_reports_source_doc_id'), 'reports', ['source_doc_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_conversations_report_id'), table_name='conversations')
    ...
    op.drop_index(op.f('ix_reports_source_doc_id'), table_name='reports')
